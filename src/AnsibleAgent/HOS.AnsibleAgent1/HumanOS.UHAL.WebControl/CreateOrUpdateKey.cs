...
namespace HumanOS.IoT.Designer.Library.Scripts
{
  ...
  /// </summary>
  public class TCreateKeyScriptObject : TAbstractHttpScriptObject
  {
                                          ...
                                          Dictionary<string, IEnumerable<string>> dicRequestHeaders)
    {
      ...
      string strPassword = Encoding.UTF8.GetString(Convert.FromBase64String((string)dicInputArguments["Password"]));

      JObject jUserNamePassword = new JObject();
      jUserNamePassword.Add(new JProperty("password", strPassword));
      jUserNamePassword.Add(new JProperty("login", dicInputArguments["UserName"]));
      
      JObject jRoot = new JObject();
      jRoot.Add(new JProperty("type", "login_password"));
      jRoot.Add(new JProperty("login_password", jUserNamePassword));
