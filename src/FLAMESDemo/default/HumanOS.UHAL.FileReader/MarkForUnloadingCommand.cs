...
/// <summary>
/// Handles the MarkForUnloading command
/// </summary>
public class TMarkForUnloadingCommand : TAbstractLogicScriptObject
{
  ...
  {
    bool bFlagValue = CallContext.getInputArgumentValue<bool>("flagValue");
    TGenericEntity[] aApplicationData = CallContext.getInputArgumentValue<TGenericEntity[]>("applicationData");

    Logger.writeInfo($"MarkForUnloadingCommand: '{DeviceNode.Name}'.");
    Logger.writeInfo($"  bFlagValue:       {bFlagValue}");
